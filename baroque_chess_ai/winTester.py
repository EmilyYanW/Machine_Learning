...
def winTester(s):
  ...
  if white_king_detected and not black_king_detected: possibleWin = "Win for BLUE"
  if black_king_detected and not white_king_detected: possibleWin = "Win for WHITE"
  return possibleWin
